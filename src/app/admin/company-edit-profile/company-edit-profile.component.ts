...
import { CompanyEditProfileService } from 'src/app/services/companyEditProfile.service';
...
export class CompanyEditProfileComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute, private companyService: CompanyService, private readonly storage: Storage,private companyEditProfileService:CompanyEditProfileService) {
  ...
  async updateCpmpany(imageInput) {
    ...
    this.companyEditProfileService.updateCompany(data).subscribe(
      (response) => {
